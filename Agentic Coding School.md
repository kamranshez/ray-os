...
- [ ] [[init-init-only-maintenance]] #claude-code 
- [ ] [[desktop-cli-to-app]] #claude-code 
- [ ] [[desktop-app-ssh]] #claude-code 
- [ ] [[using-cc-in-wsl]] #claude-code 
- [ ] [[front-end-design-skill]] #claude-code 
- [ ] [[from-pr-command]] #claude-code 
- [ ] [[skill-creator-with-evals]] #claude-code 
- [ ] [[claude-code-aliases]] #claude-code 
- [ ] [[figma-claude-integration]] #claude-code 
...
- [ ] Cmux #claude-code
- [ ] [[three-modes-chat-cowork-code]] #business 
- [ ] [[box-cli-filesystem-for-ai-agents]] #business 
- [ ] [[ai-agents-managing-other-agents]] #business 
- [ ] [[deep-research-with-exa]] #business 
- [ ] [[research-loops]] #business 
- [ ] [[parallel-subagents-for-business]] #business 
- [ ] [[social-media-content-engine]] #business 
- [ ] [[linkedin-via-claude-mcp]] #business 
- [ ] [[lead-research-and-outreach]] #business 
- [ ] [[agent-mail]] #business 
- [ ] [[encoding-your-expertise-into-skills]] #business 
...
- [ ] [[persona-vectors]] #prompt-engineering 
...
- [x] [[01-steering-distributions]] #prompt-engineering 
