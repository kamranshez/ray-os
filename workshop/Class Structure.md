...
- [ ] [[Installing CC + Ghostty (Windows)]]
- [ ] [[Navigating to Slack]]
- [ ] [[Basic Commands for CC]]
- [ ] [[Scope (Project & User Level)]]
- [ ] [[Install Codex App]]
- [ ] [[Overview of Codex App]]
- [ ] [[Office Hours]]
...
# Day 3 — Steering
- [x] [[Dealing with Syncophancy]]
- [x] [[Instruction Following Limits]]
- [x] [[Boxing the Agent In]]
- [x] [[Context Switching]]
- [x] [[Just Run It Again]]
- [x] [[Gravitational Pull from Older Models]]
- [x] [[High-Level Coherence, Low-Level Implementation]]
- [x] [[Getting Prompt Feedback]]
- [x] [[Persona Vectors]]
