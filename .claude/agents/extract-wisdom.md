...
name: extract-wisdom
description: >
  Extract structured wisdom, insights, and actionable takeaways from any content — podcasts, articles, videos, transcripts, books, or conversations. Use this subagent whenever you need to "extract wisdom", "summarize insights", "pull out key ideas", "what are the takeaways", "extract the best parts", "distill this content", "what did I learn from this", or when given a transcript/article and asked for a structured breakdown. Also trigger when long-form content needs the signal extracted from the noise — even if the word "wisdom" isn't used. Inspired by Daniel Miessler's Fabric pattern.
---
