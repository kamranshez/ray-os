...
def build_note(candidate, source_url, permanent_tag):
    ...
    # Only claude-* tags by user request. Other contextual data (speaker, bank_id,
    # i_level, source_id, source_url, auto-mined date) lives in the draft JSON
    # for debugging, but isn't promoted to Anki tags.
    tags = [permanent_tag]
