...
| **V37** | 2026-07-18 | `2026-07/2026-07-18-boris-levels.md` | Boris Cherny's "4 levels of AI adoption" thesis walkthrough — V30-loops replay. R1 title test flat (0.7pp across authority/ranking/pillar). Subscriber-skip flag FIRED at 7h04m ("24% fewer views"), views 2.3K vs 3–6.2K band, rank 8/10, CTR 8.2%↓ — but AVD 4:47↑ green. Split diagnosis: content holds, the CLICK caps, and it's the thesis FORMAT not the title. First-7h cohort: "Anthropic Just Dropped [artifact]" launches lead (13.3K/12.6K), thesis videos trail. Durable lesson: package as feature-drop, not levels-thesis. Ray locked variant 2 + ran a 2nd title round anyway. Ray's local numbering calls it "35" |
